...
# constructor
fungi <- function(n, x, y, species)
  new("fungi", n=n, x=x, y=y, species=species)

n <- 5
fg1 <- fungi(n=n, x = runif(n), y = runif(n),
              species = sample(letters[1:5], n, rep=T))

fg1

n <- 10
fg2 <- fungi(n=n, x = runif(n), y = runif(n),
              species = sample(letters[1:5], n, rep=T))
fg2
```
